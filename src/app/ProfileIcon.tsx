...
export default function ProfileIcon({gradientNum, onDashboard, name}: IProfileIconProps):JSX.Element {
    ...
    return(
        <div className={`${onDashboard ? ' text-lg size-12' : ' text-4xl size-[125px]'} text-white flex justify-center items-center rounded-full ${gradientColors[gradientNum]}`} style={{textShadow:"rgba(0, 0, 0, 0.5) 2px 2px 4px"}}>

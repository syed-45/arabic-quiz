CREATE TABLE IF NOT EXISTS "chapters" (
	"chapter_number" integer PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS "user_scores" (
	...
	CONSTRAINT "user_scores_user_id_chapter_number_pk" PRIMARY KEY("user_id","chapter_number")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "user_scores" ADD CONSTRAINT "user_scores_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
